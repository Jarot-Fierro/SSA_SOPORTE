...
urlpatterns = [
    ...
    path('detalle-departamentos/<int:pk>/detalle/', DepartamentoDetailView.as_view(),
         name='detail_departamentos'),
    path('crear-departamentos/', DepartamentoCreateView.as_view(), name='create_departamentos'),
    path('actualizar-departamentos/<int:pk>/detalle/', DepartamentoUpdateView.as_view(),
         name='update_departamentos'),
    path('historial-departamentos/', DepartamentoHistoryListView.as_view(), name='historical_departamentos'),

    # FUNCIONARIOS
    path('lista-funcionario/', FuncionarioListView.as_view(), name='list_funcionarios'),
    path('detalle-funcionario/<int:pk>/detalle/', EstablecimientoDetailView.as_view(),
         name='detail_funcionarios'),
    path('crear-funcionario/', FuncionarioCreateView.as_view(), name='create_funcionarios'),
    path('actualizar-funcionario/<int:pk>/detalle/', FuncionarioUpdateView.as_view(),
         name='update_funcionarios'),
    path('historial-funcionario/', FuncionarioHistoryListView.as_view(), name='historical_funcionarios'),
