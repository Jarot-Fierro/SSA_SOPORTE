...
from catalogo.forms.modelo import FormModelo
...
class ModeloListView(DataTableMixin, TemplateView):
    ...
    datatable_order_fields = ['id', None, 'modelo__nombre']
    datatable_search_fields = ['nombre__icontains', 'modelo__nombre__icontains']

    url_detail = 'detail_modelo'
    url_update = 'update_modelo'
    ...
    def get_context_data(self, **kwargs):
        ...
        context.update({
            ...
            'list_url': reverse_lazy('list_modelo'),
            'create_url': reverse_lazy('modelo_create'),
...
class ModeloCreateView(IncludeUserFormCreate, CreateView):
    ...
    success_url = reverse_lazy('list_modelo')

    def form_valid(self, form):
        messages.success(self.request, 'Modelo creada correctamente')
