...
from catalogo.forms.categoria import FormCatalogo
...
MODULE_NAME = 'Catalogos'


class CatalogoListView(DataTableMixin, TemplateView):
...
class CatalogoCreateView(IncludeUserFormCreate, CreateView):
    template_name = 'categoria/form.html'
    model = Catalogo
    form_class = FormCatalogo
    success_url = reverse_lazy('list_categorias')

    def form_valid(self, form):
        messages.success(self.request, 'Catalogo creada correctamente')
...
class CatalogoUpdateView(IncludeUserFormUpdate, UpdateView):
    template_name = 'categoria/form.html'
    model = Catalogo
    form_class = FormCatalogo
    success_url = reverse_lazy('list_categorias')
...
class CatalogoHistoryListView(GenericHistoryListView):
    base_model = Catalogo
