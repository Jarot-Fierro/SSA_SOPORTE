...
from catalogo.forms.contrato import FormContrato
...
class ContratoListView(DataTableMixin, TemplateView):
    ...
    datatable_order_fields = ['id', None, 'contrato__nombre']
    datatable_search_fields = ['nombre__icontains', 'contrato__nombre__icontains']

    url_detail = 'detail_contrato'
    url_update = 'update_contrato'
    ...
    def get_context_data(self, **kwargs):
        ...
        context.update({
            'title': 'Listado de Contrato',
            'list_url': reverse_lazy('list_contrato'),
            'create_url': reverse_lazy('create_contrato'),
...
class ContratoCreateView(IncludeUserFormCreate, CreateView):
    ...
    def form_valid(self, form):
        messages.success(self.request, 'Contrato creada correctamente')
