...
class TipoCelularListView(DataTableMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context.update({
            'title': 'Listado de Tipo Celulares',
            'list_url': reverse_lazy('list_tipo_celular'),
            'create_url': reverse_lazy('create_tipo_celular'),
...
class TipoCelularCreateView(IncludeUserFormCreate, CreateView):
    ...
    def form_valid(self, form):
        messages.success(self.request, 'Tipo Celular creada correctamente')
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Nuevo Tipo Celular'
...
class TipoCelularUpdateView(IncludeUserFormUpdate, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Editar Tipo Celular'
        context['list_url'] = self.success_url
        context['action'] = 'edit'
        context['module_name'] = MODULE_NAME
        return context
